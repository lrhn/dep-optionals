...
\LMHash{}
Let $F$ be a function with required formal parameters $T_1$ $p_1 \ldots, T_n$ $p_n$, return type $T_0$, positional optional parameters $T_{n+1}$ $p_{n+1}, \ldots, T_{n+k}$ $ p_{n+k}$ and no named optional parameters. Then the type of $F$ is $(T_1 ,\ldots, T_n, [T_{n+1}$ $p_{n+1}, \ldots, T_{n+k}$  $p_{n+k}]) \rightarrow T_0$.

\LMHash{}
Let $F$ be a function with required formal parameters $T_1$ $p_1 \ldots, T_n$ $p_n$, return type $T_0$, no positional optional parameters and named optional parameters $T_{n+1}$ $p_{n+1}, \ldots, T_{n+k}$ $ p_{n+k}$. Then the type of $F$ is $(T_1 ,\ldots, T_n, \{T_{n+1}$ $p_{n+1}, \ldots, T_{n+k}$  $p_{n+k}\}) \rightarrow T_0$.

\LMHash{}
Let $F$ be a function with required formal parameters $T_1$ $p_1 \ldots, T_n$ $p_n$, return type $T_0$, positional optional parameters $T_{n+1}$ $p_{n+1}, \ldots, T_{n+k}$ $ p_{n+k}$ and named optional parameters $T_{n+k+1}$ $p_{n+k+1}, \ldots, T_{n+k+m}$ $ p_{n+k+m}$. Then the type of $F$ is $(T_1 ,\ldots, T_n, [\{T_{n+1}$ $p_{n+1}, \ldots, T_{n+k}$  $p_{n+k}], \{T_{n+k+1}$ $p_{n+k+1}, \ldots, T_{n+k+m}$  $p_{n+k+m}\}) \rightarrow T_0$.
...
$(T_1 \ldots, T_n, [T_{n+1}$ $x_{n+1}, \ldots, T_{n+k}$ $x_{n+k}], \{T_{n+k+1}$ $x_{n+1}, \ldots, T_{n+k+m}$ $x_{n+k+m}\})) \rightarrow T_0$, where $T_0$ is the static type of $e$.
...
is $(T_1 \ldots, T_n, [T_{n+1}$ $x_{n+1}, \ldots, T_{n+k}$ $x_{n+k}], \{T_{n+k+1}$ $x_{n+1}, \ldots, T_{n+k+m}$ $x_{n+k+m}\}) \rightarrow Future<flatten(T_0)>$, where $T_0$ is the static type of $e$ and  $flatten(T)$ is defined as follows:
...
is $(T_1 \ldots, T_n, [T_{n+1}$ $x_{n+1}, \ldots, T_{n+k}$ $x_{n+k}], \{T_{n+k+1}$ $x_{n+1}, \ldots, T_{n+k+m}$ $x_{n+k+m}\}) \rightarrow  \DYNAMIC{}$.
...
is $(T_1 \ldots, T_n, [T_{n+1}$ $x_{n+1}, \ldots, T_{n+k}$ $x_{n+k}], \{T_{n+k+1}$ $x_{n+1}, \ldots, T_{n+k+m}$ $x_{n+k+m}\}) \rightarrow Future$.

\LMHash{}
The static type of a function literal of the form  

$(T_1$ $a_1, \ldots, T_n$ $a_n, [T_{n+1}$ $x_{n+1} = d_1, \ldots, T_{n+k}$ $x_{n+k}= d_k], \{T_{n+k+1}$ $x_{n+k+1} : d_{k+1}, \ldots,  T_{n+k+m}$ $x_{n+k+m} : d_{k+m}\})$ $ \ASYNC*{}$ $\{s\}$
is $(T_1 \ldots, T_n, [T_{n+1}$ $x_{n+1}, \ldots, T_{n+k}$ $x_{n+k}], \{T_{n+k+1}$ $x_{n+1}, \ldots, T_{n+k+m}$ $x_{n+k+m}\}) \rightarrow Stream$.
...
is $(T_1 \ldots, T_n, [T_{n+1}$ $x_{n+1}, \ldots, T_{n+k}$ $x_{n+k}], \{T_{n+k+1}$ $x_{n+1}, \ldots, T_{n+k+m}$ $x_{n+k+m}\}) \rightarrow Iterable$.
